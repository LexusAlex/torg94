...
class SpecprojectsController extends \yii\web\Controller
{
    public function actionIndex()
    {
        $this->layout = 'allNews';

        $records = Record::find()->andWhere(['status'=>1,'tid'=>9])->with(['t'])->orderBy('date DESC');
